...
import {TileLayer} from "./_snowpack/pkg/@deck.gl/geo-layers.js";
import {BitmapLayer} from "./_snowpack/pkg/@deck.gl/layers.js";
import {load} from "./_snowpack/pkg/@loaders.gl/core.js";
import {ImageLoader} from "./_snowpack/pkg/@loaders.gl/images.js";
import GL from "./_snowpack/pkg/@luma.gl/constants.js";
import Deck from "./_snowpack/pkg/deck.gl.js";
import React, {useState} from "./_snowpack/pkg/react.js";
import {HsvColorPicker} from "./_snowpack/pkg/react-colorful.js";
...
function ChannelControl(props) {
  ...
  }, name), /* @__PURE__ */ React.createElement(HsvColorPicker, {
    color,
    onChange: setColor
  }));
}
...
function App() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Deck, {
    layers: [
  ...
  }, /* @__PURE__ */ React.createElement(ChannelControl, {
    name: "DNA",
    color: color1,
    setColor: setColor1,
    visible: visible[0],
    toggleVisible: toggleVisibleI(0)
  }), /* @__PURE__ */ React.createElement(ChannelControl, {
    name: "Ki-67",
    color: color2,
    setColor: setColor2,
    visible: visible[1],
    toggleVisible: toggleVisibleI(1)
  }), /* @__PURE__ */ React.createElement(ChannelControl, {
    name: "Keratin",
    color: color3,
    setColor: setColor3,
    visible: visible[2],
    toggleVisible: toggleVisibleI(2)
  }), /* @__PURE__ */ React.createElement(ChannelControl, {
    name: "CD3D",
    color: color4,
    setColor: setColor4,
    visible: visible[3],
    toggleVisible: toggleVisibleI(3)
  }), /* @__PURE__ */ React.createElement(ChannelControl, {
    name: "CD4",
    color: color5,
    setColor: setColor5,
    visible: visible[4],
    toggleVisible: toggleVisibleI(4)
  }), /* @__PURE__ */ React.createElement(ChannelControl, {
    name: "CD45",
    color: color6,
    setColor: setColor6,
    visible: visible[5],
    toggleVisible: toggleVisibleI(5)
  }), /* @__PURE__ */ React.createElement(ChannelControl, {
    name: "CD8A",
    color: color7,
    setColor: setColor7,
    visible: visible[6],
    toggleVisible: toggleVisibleI(6)
  }), /* @__PURE__ */ React.createElement(ChannelControl, {
    name: "\u03B1SMA",
    color: color8,
    setColor: setColor8,
    visible: visible[7],
    toggleVisible: toggleVisibleI(7)
  }), /* @__PURE__ */ React.createElement(ChannelControl, {
    name: "CD20",
    color: color9,
    setColor: setColor9,
    visible: visible[8],
    toggleVisible: toggleVisibleI(8)
  })));
}
export default App;
